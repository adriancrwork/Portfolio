...
function playSlide(slide, { muted = true, mode = 'hover' } = {}) {
  ...
  iframe.src = `https://www.youtube.com/embed/${id}?autoplay=1&mute=${muteParam}&loop=1&playlist=${id}&controls=0&modestbranding=1&rel=0&playsinline=1&iv_load_policy=3`;
